...
export default function Sidebar() {
  ...
  return (
    <>
          ...
          <section className="h-full  w-full fixed top-0 left-0 z-20 flex flex-col">
            ...
            <div className="h-[80%] flex items-center justify-center px-2">
              <div className="bg-white w-full rounded-[9px] overflow-hidden ">
                <div className=" h-[50px] flex items-center justify-between border-b border-whitish_border px-4">
                  <div className="">
      ...
      <section className="bg-white min-w-[280px] h-screen border-r border-whitish_border flex flex-col max-md:hidden">
      ...
      <section className="md:hidden fixed w-full left-0 top-[12px] h-[70px] flex items-center justify-center">
        <div className="h-full w-[97%] bg-white border border-whitish_border rounded-[9px] flex items-center justify-between px-3">

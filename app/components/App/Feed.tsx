...
export default function Feed({ notifications }: { notifications: any }) {
    ...
    ? createPortal(
        <Polygon additionalClasses={`w-[500px] max-md:w-[96%] max-md:rounded-[7px]`} onClickEvent={() => setModalOpen(false)} closable>
                  ...
                  <div className="flex flex-col gap-y-1.5 w-full">
                    <div className="flex justify-between w-full items-center">
                      <div className="w-full">
                        ...
                        <span className="text-accent_blue font-semibold text-[12px] relative bottom-0.5">{notification.title}</span>
                       </div>
          ...
          <div className="border-t border-whitish_border w-full px-4 h-[65px] flex items-center">
            <button className="rounded-[6px] py-2.5 font-semibold text-[13px] tracking-wide text-accent_blue" onClick={() => clearNotifications()}>

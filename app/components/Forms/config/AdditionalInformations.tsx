    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div
                            ...
                            {preview ? (
                                <div className="relative w-full h-full" onClick={e => handleZoom(e, preview)}>
                                    <Image src={preview} height={100} width={100} alt={`Aperçu ${index}`}
                                           className="w-full h-full object-cover"/>
                                    {index === 0 && (
                                        <div
                                            className="absolute bottom-[6px] left-1 w-fit px-2 h-[17px] rounded-full bg-white/[.4] flex items-center justify-center">
                ...
                <div className="mt-2">
                    <small className="text-[12px] text-subtitle_foreground">Astuce : Clique sur une image pour zoomer
                        dessus</small>
                </div>
                <div className="mt-4">

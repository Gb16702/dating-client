...
import AdditionalInformations from "./config/AdditionalInformations";
...
export default function ConfigForm({step, onNextStep, data, sessionId}: ConfigFormProps): JSX.Element {
    ...
    if (step.current === 1) {
        return <BirthDate onNextStep={onNextStep} initialBirthDate={birthDate}
        ...
        return <PreferredGender onNextStep={onNextStep} initialPreferredGender={preferredGender}
                                onGenderChange={handlePreferredGenderChange}/>;
        ...
        return <Tracks sessionId={sessionId} setAchieved={setAchieved} initialTracks={tracks}
                       onTrackChange={handleTrackChange}
                       lastStepLoading={loading}
        />;
    }

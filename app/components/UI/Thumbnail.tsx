        ...
        <div className={`w-full h-full flex items-center justify-between relative`}>
          ...
          {open && (
            <div
              ...
              ref={ref}>
              <button className="h-1/2 w-full text-[14px] font-medium border-b border-whitish_background px-2 text-left text-subtitle_foreground">
                Thème sombre
              </button>
              <button className="h-1/2 text-[14px] font-medium text-red-400 px-2  w-full text-left" onClick={handleLogout}>
                Déconnexion
              </button>
            </div>
          )}

...
export default function Inscription(): JSX.Element {
  return (
    <div className="w-full h-full">
      ...
      <h2 className="mt-1 font-medium text-[12px] text-subtitle_foreground">Crée un nouveau compte</h2>
      ...
      <SocialAuth />
      <Link href="/authentification/connexion" className="block font-medium text-xs mt-5 text-subtitle_foreground">
        Déjà membre ? <span className="underline text-black">Se connecter</span>
      </Link>
    </div>
  );
}

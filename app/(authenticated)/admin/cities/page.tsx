...
async function getCities({search, page}: searchParamsProps) {
    const url = `${process.env.NEXT_PUBLIC_SERVER}api/admin/cities/paginated?page=${page}&search=${search}`
    ...
    return (
        <div className='p-4 space-y-4'>
            ...
            <div className='flex justify-between py-4'>
                ...
                <Link href='/admin/cities/create' className='btn bg-white rounded h-10 px-4 py-2 border border-input'>Add
                    City</Link>
            </div>
